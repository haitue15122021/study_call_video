...
///Trong WebRTC, việc gửi và nhận dữ liệu không chỉ giới hạn trong việc truyền trực tiếp hình ảnh và âm thanh,
///mà còn cho phép truyền gửi dữ liệu tùy ý (arbitrary data) qua kết nối RTCPeerConnection.
///Dữ liệu truyền tải có thể là 1 string, 1 file...
///Trong meeyteam dùng datachanel chuyền tải các thông điệp như bật tắt micro
///(máy 1 bật tắt micro muốn biết máy 2 biết điều này).
