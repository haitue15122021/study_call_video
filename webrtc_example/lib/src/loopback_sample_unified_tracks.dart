...
/*
1 demo để test việc truyền hình ảnh âm thanh (thu  âm thanh bên local rồi truyền cho remote hiển thị đúng âm thanh đó)
Cũng không khác nhiều so với ví dụ 2
-việc mã hóa audio/video giúp giảm dung lượng media stream truyền tải và đảm bảo chất lượng âm thanh/hình ảnh
-Có sử dụng 1 sturn server của google (tuy nhiên trường hợp này ko bắt buộc)
-4: nút gọi lần lượt từ phải qua trái
+Make call (thực hiện cuộc gọi trước rồi mới sử dụng các nút bên trái)
+Bật/tắt camera (app chat sẽ có chức năng bật tắt camera)
+Switch loa ngoài/loa trong
+Bật/tăt micro (tắt micro thì sẽ ko thể thu được tiếng nữa, khi ko muốn nói như ứng dụng zoom chẳng hạn).
*/
