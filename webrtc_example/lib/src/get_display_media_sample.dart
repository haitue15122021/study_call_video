...
/*
 * 1 demo đơn giản để chụp ảnh màn hình hiển thị lên local rendere
 * Có sử dụng FlutterBackground.enableBackgroundExecution() để keep app khi app chuyển xuống background
 * Mặc định khi app đang call mà chuyển xuống trang thái background sau vài phút có thể bị kill làm gián đoạn cuộc gọi
 * ==>Giả pháp là dung FlutterBackground.enableBackgroundExecution() để keep tiến trình gọi tiếp tục working.
 * Lưu ý việc keep 1 tiến trình working ở background có thể ảnh hưởng đến việc tiêu thụ điện năng của máy và phải request permisson.
 */
